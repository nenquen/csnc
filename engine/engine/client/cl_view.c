...
static void V_AddLag_HL2( vec3_t origin, vec3_t front )
{
	...
	VectorMA_KopaFish( delta_front, viewmodel_lag_speed->value * cl.refdef.frametime, last_front );// Xashdaki VectorMA Hata veriyor Sadece Ald�g�m yerdeki VectorMA'y� kullan�yorum
